...
(function () {
  ...
  const I18N = {
    it: {
      ...
      'hero.lede2': "Ho studiato pubblicità e marketing, poi ho lavorato sul campo. Parto sempre dall'ascolto: chi fa il lavoro, dove perde tempo, cosa serve davvero. Da lì costruisco la soluzione, insieme al cliente.",
      ...
      'hero.s1d': "Ogni progetto parte dall'ascolto del cliente e dall'analisi del problema. Non dal codice.",
      ...
      'profilo.lede': "Vengo dal marketing e dalla comunicazione, e da diversi anni costruisco strategia e direzione di progetti di brand, web e comunicazione per aziende e professionisti. Negli ultimi tre anni ho fatto dell'<em>AI uno strumento di lavoro quotidiano</em>: non un oggetto da raccontare, ma una leva concreta per liberare tempo, ridurre il lavoro manuale, dare al team più spazio per pensare e decidere.",
